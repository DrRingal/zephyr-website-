...
.PlanetAfter{
    ...
    <body class="background">
        ...
        <div class="header">
            ...
            <a href="https://en.wikipedia.org/wiki/Venus" class="PlanetBefore" style="left:2%; top:14%">Venus</a>
            <a href="https://en.wikipedia.org/wiki/Mars" class="PlanetAfter" style="right:2%; top:14%">Mars</a>
        </div>
        <div>
