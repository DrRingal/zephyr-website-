...
.PlanetAfter{
    ...
    <body class="background">
        ...
        <div class="header">
            ...
            <a href="https://en.wikipedia.org/wiki/Mercury_(planet)" class="PlanetBefore" style="left:2%; top:14%">Mercury</a>
            <a href="https://en.wikipedia.org/wiki/Earth" class="PlanetAfter" style="right:2%; top:14%">Earth</a>
        </div>
        <div>
